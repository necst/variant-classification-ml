...
g.fig.suptitle("F1 Score Analysis", fontsize=16)
g.set_axis_labels("Dataset Size", "F1 Score")

plt.savefig(os.path.join(RESULTS_DIR, "f1_results.png"), dpi=150, bbox_inches='tight')
plt.close()